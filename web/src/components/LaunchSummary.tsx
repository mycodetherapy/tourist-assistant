  ...
  return (
    <div className="max-w-xl space-y-4">
      <Alert
        ...
        description="Три альтернативных маршрута на всю поездку (варианты A, B, C) с местами досуга из Wikidata. У каждого варианта — ссылка «Открыть маршрут в Яндекс.Картах»; факт о городе подгрузится отдельно."
      />
