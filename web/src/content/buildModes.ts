...
export const HOW_ROUTES_WORK_SECTIONS = [
  ...
  {
    title: "Карта",
    body: "Линия по улицам появляется, когда для города есть пеший граф на сервере. Иначе остаётся виджет Яндекс.Карт. Это не зависит от бесплатного или LLM-режима.",
  },
] as const;
