...
| **Опора на поиск** | Маршруты A/B/C: 3–10 leisure-точек из пула, мин. 1 км (компактный город) или 3 км (размашистый), без повторов названий; `maps_route_url` по координатам (иногда кольцевой); питание — «Искать вдоль маршрута» в Яндекс.Картах |
